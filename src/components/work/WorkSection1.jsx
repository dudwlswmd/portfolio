...
import TypewriterApi2 from './TypewriterApi2';
          ...
          <div className='WorkSection1'>
               <div className='containerSection'>
                    ...
                    <div className='right one'>
                         <img className='dolLogo' src="/img/logo-bvb.svg" alt="돌문로고" />
                         <img className='dolLogo two' src="/img/logo-bvb.svg" alt="돌문로고" />
                         <div className="move_text_box_two">
                              <div className="text">
                                   <p> DORTMUND  WEB SITE </p>
                                   <p> DORTMUND  WEB SITE </p>
                                   <p> DORTMUND  WEB SITE </p>
                                   <p> DORTMUND  WEB SITE </p>
                                   <p> DORTMUND  WEB SITE </p>
               ...
               <div className='containerSection two'>
                    {/* <div className='seBg01'></div> */}
                    <img className='ygLogo' src="/img/logo_ygfamily_h.svg" alt="와이지 로고" />
                    <img className='mic' src="/img/ygmic.jpg" alt="마이크" />
                    <img src="/img/onecucle.png" className="img" alt="써클로고"></img>
                    <a href="https://dudwlswmd.github.io/YG/" target="_blank" rel="noopener noreferrer">Web Site GO!!</a>
                    <div className='cucleG'>
                         <img src="/img/onecucle.png" className="img two" alt="써클로고"></img>
                         <img src="/img/YG-ENTERTAINMENT.webp" className="img logo" alt="와지로고"></img>
                    </div>
               ...
               <div className='containerSection three'>
                         <div className="move_text_box_two">
                              <div className="text">
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                         ...
                         <div className='h2'>POP <span> MART</span><p className='popup' onClick={handlePopupClick}>팝마트 설명 보기</p></div>
                         <dl className='dl01'>
                              <dt>
                                   {/* RECOMMENDER */}
                                   <TypewriterApi2/>
                         ...
                         <div className="move_text_box_two two ">
                              <div className="text">
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                                   <p> POP MART RECOMMENDER WEP APP Discover</p>
                         ...
                         <div className={`popmartExplanation${isModalOpen ? ' on' : ''}`}>
                              <p className='closed' onClick={handleCloseClick}></p>
                              <dl>
                                   <dt>
                                        추천 시스템 웹앱 개발
                                   </dt>
